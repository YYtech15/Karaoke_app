...
const SongsBySearch: React.FC<SongCardProps> = ({ item, index }) => {
    return (
        <div
            key={index}
            className="min-h-[400px] m-2 p-4 rounded-lg border-2 border-dashed border-blue-700 bg-blue-50 relative"
        >
